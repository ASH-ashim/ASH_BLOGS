...
import { createComment, deleteComment, editComment, getAllCommentOnlyBlogs, getCommentsOfPost, likeComment } from '../controllers/comment.controller.js';
...
router.get('/my-blogs/comments', isAuthenticated, getAllCommentOnlyBlogs)
